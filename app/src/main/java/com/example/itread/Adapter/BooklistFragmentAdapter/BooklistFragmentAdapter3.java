...
public class BooklistFragmentAdapter3 extends RecyclerView.Adapter<BooklistFragmentAdapter3.ViewHolder>{
    ...
    public BooklistFragmentAdapter3(Context context, List<Map<String, Object>> list) {
    ...
    @NonNull
    @Override
    public BooklistFragmentAdapter3.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType==1){
            View view = LayoutInflater.from(context).inflate(R.layout.item_booklist, parent, false);
            return new BooklistFragmentAdapter3.ViewHolder(view);
        }
        else {
            View view2 = LayoutInflater.from(context).inflate(R.layout.item_real_empty, parent, false);
            return new BooklistFragmentAdapter3.ViewHolder(view2);
        }

    }
    @Override
    public void onBindViewHolder(@NonNull BooklistFragmentAdapter3.ViewHolder holder, final int position) {
