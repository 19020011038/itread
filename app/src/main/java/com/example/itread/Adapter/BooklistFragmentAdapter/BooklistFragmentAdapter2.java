...
public class BooklistFragmentAdapter2 extends RecyclerView.Adapter<BooklistFragmentAdapter2.ViewHolder>{
    ...
    public BooklistFragmentAdapter2(Context context, List<Map<String, Object>> list) {
    ...
    @NonNull
    @Override
    public BooklistFragmentAdapter2.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                if (viewType==1){
        View view = LayoutInflater.from(context).inflate(R.layout.item_booklist, parent, false);
        return new BooklistFragmentAdapter2.ViewHolder(view);
        }
        else {
            View view2 = LayoutInflater.from(context).inflate(R.layout.item_real_empty, parent, false);
            return new BooklistFragmentAdapter2.ViewHolder(view2);
        }

    }
    @Override
    public void onBindViewHolder(@NonNull BooklistFragmentAdapter2.ViewHolder holder, final int position) {
